...
#currently this file will create a status file in the apache root which can then be co                                                                                                                        nsumed by the lcd util server and docker apache to display the status
...
while True:
    ...
    if(input_22 == 0):
        ...
        if last_status != "closed":
            ...
            last_status = "closed"
        with open("/var/www/html/status.json", "r") as read:
        ...
        if last_status != "open":
            ...
            #write to file that will be served up as JSON to be consumed by LCD and Do                                                                                                                        cker webserver
            if last_status != "open":
